...
public static class APIConfig {
    ...
    public static string URL_SessionID = "http://192.168.1.4:8000/api/auth/login";
    public static string URL_AccountData = "http://192.168.1.4:8000/api/user/account";
    public static string URL_GuestLogin = "http://192.168.1.4:8000/api/auth/guestlogin";
    public static string URL_CreateCharacter = "http://192.168.1.4:8000/api/char/add";
    public static string URL_SelectCharacter = "http://192.168.1.4:8000/api/char/select";
